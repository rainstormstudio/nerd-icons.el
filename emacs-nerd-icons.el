...
(defvar emacs-nerd-icons-extension-icon-alist
  '(
    ...
    ;; Audio
    ("mp3" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("wav" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("m4a" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("ogg" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("flac" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("opus" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("au" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("aif" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("aifc" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)
    ("aiff" emacs-nerd-icons-mdicon "nf-md-file_music" :face all-the-icons-dred)

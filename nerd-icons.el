...
(defvar nerd-icons-extension-icon-alist
  '(
    ...
    ("l"              nerd-icons-sucicon "nf-custom-common_lisp" :face nerd-icons-orange)
    ("lisp"           nerd-icons-sucicon "nf-custom-common_lisp" :face nerd-icons-orange)
    ("lsp"            nerd-icons-sucicon "nf-custom-common_lisp" :face nerd-icons-orange)
    ("hy"             nerd-icons-sucicon "nf-custom-common_lisp" :face nerd-icons-blue)
    ...
    ("rkt"            nerd-icons-mdicon "nf-md-lambda"           :face nerd-icons-red)
    ("scrbl"          nerd-icons-mdicon "nf-md-lambda"           :face nerd-icons-blue)
    ;; Stylesheeting
...
(defvar nerd-icons-mode-icon-alist
  '(
    ...
    (sly-mrepl-mode                    nerd-icons-mdicon "nf-md-yin_yang"             :face nerd-icons-orange)
    (slime-repl-mode                   nerd-icons-mdicon "nf-md-yin_yang"             :face nerd-icons-orange)
    ...
    (lisp-mode                         nerd-icons-sucicon "nf-custom-common_lisp"     :face nerd-icons-orange)

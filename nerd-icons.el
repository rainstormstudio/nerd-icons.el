...
(defvar nerd-icons-extension-icon-alist
  '(
    ...
    ("git"            nerd-icons-devicon "nf-seti-git"            :face nerd-icons-lred)
    ("gitattributes"  nerd-icons-devicon "nf-seti-git"            :face nerd-icons-lred)
    ("gitignore"      nerd-icons-devicon "nf-seti-git"            :face nerd-icons-lred)
    ("gitmodules"     nerd-icons-devicon "nf-seti-git"            :face nerd-icons-lred)

...
(defvar nerd-icons-extension-icon-alist
  '(
    ...
    ;; Lisps
    ("cl"             nerd-icons-mdicon "nf-md-yin_yang"         :face nerd-icons-lorange)
    ("l"              nerd-icons-mdicon "nf-md-lambda"           :face nerd-icons-orange)
    ("lisp"           nerd-icons-mdicon "nf-md-lambda"           :face nerd-icons-orange)
    ("hy"             nerd-icons-mdicon "nf-md-yin_yang"         :face nerd-icons-blue)
...
(defvar nerd-icons-mode-icon-alist
  '(
    ...
    (lisp-mode                         nerd-icons-mdicon "nf-md-lambda"               :face nerd-icons-orange)

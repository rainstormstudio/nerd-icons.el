...
(defvar nerd-icons-extension-icon-alist
  '(
    ...
    ("log" nerd-icons-octicon "nf-oct-bug" :face nerd-icons-maroon)
    ;; Config
    ...
    ("ini" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-yellow)
    ...
    ("json" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-yellow)
    ("cson" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-yellow)
    ("yml" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-dyellow)
    ("yaml" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-dyellow)
    ("toml" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-orange)
    ("conf" nerd-icons-octicon "nf-oct-settings" :face nerd-icons-dorange)
    ;; ?
    ...
    ("inky-slim" nerd-icons-octicon "nf-oct-dashboard" :face nerd-icons-yellow)
    ("slim" nerd-icons-octicon "nf-oct-dashboard" :face nerd-icons-yellow)
    ...
    ("tsx"          nerd-icons-devicon "nf-dev-javascript" :face nerd-icons-cyan-alt)
    ...
    ;; Doc
    ("pdf" nerd-icons-octicon "nf-oct-file_pdf" :face nerd-icons-dred)
    ("text" nerd-icons-octicon "nf-oct-file_text" :face nerd-icons-cyan)
    ("txt" nerd-icons-octicon "nf-oct-file_text" :face nerd-icons-cyan)
    ...
    ("texi"         nerd-icons-mdicon "nf-md-format_text" :face nerd-icons-lred)
    ("tex"          nerd-icons-mdicon "nf-md-format_text" :face nerd-icons-lred)
...
(defvar nerd-icons-mode-icon-alist
  '(
    ...
    (mu4e-view-mode            nerd-icons-octicon "nf-oct-mail_read"           )
    ...
    (gnus-article-mode         nerd-icons-octicon "nf-oct-mail_read"           )
    ...
    (text-mode                          nerd-icons-octicon "nf-oct-file_text"          :face nerd-icons-cyan)
    ...
    (conf-mode                          nerd-icons-octicon "nf-oct-settings"          :face nerd-icons-lyellow)
    (json-mode                          nerd-icons-octicon "nf-oct-settings"          :face nerd-icons-yellow)
    (json-ts-mode                       nerd-icons-octicon "nf-oct-settings"          :face nerd-icons-yellow)
    (jsonian-mode                       nerd-icons-octicon "nf-oct-settings"          :face nerd-icons-yellow)
    (yaml-mode                          nerd-icons-octicon "nf-oct-settings"           :face nerd-icons-dyellow)
    (yaml-ts-mode                       nerd-icons-octicon "nf-oct-settings"           :face nerd-icons-dyellow)
    (toml-mode                          nerd-icons-octicon "nf-oct-settings"           :face nerd-icons-orange)
    (toml-ts-mode                       nerd-icons-octicon "nf-oct-settings"           :face nerd-icons-orange)
    ...
    (slim-mode                          nerd-icons-octicon "nf-oct-dashboard"          :face nerd-icons-yellow)
    ...
    (elfeed-show-mode                   nerd-icons-faicon   "nf-fa-rss"              :face nerd-icons-orange)
...
(defvar nerd-icons-url-alist
  '(
    ...
    ("^\\(https?://\\)?\\(www\\.\\)?gist\\.github\\.com" nerd-icons-octicon "nf-oct-gist")
    ...
    ("forums?" nerd-icons-octicon "nf-oct-comment_discussion")
    ("\\.pdf$" nerd-icons-octicon "nf-oct-file_pdf" :face nerd-icons-dred)
...
Note: You want chevron, please use `nerd-icons-icon-for-dir-with-chevron'."
  (let* ((dirname (file-name-base (directory-file-name dir)))
    ...
    (cond
     ...
     ((file-symlink-p path)
      (apply #'nerd-icons-octicon "nf-oct-file_symlink_directory" (cdr args)))
     ((nerd-icons-dir-is-submodule path)
      (apply #'nerd-icons-octicon "nf-oct-file_submodule" (cdr args)))

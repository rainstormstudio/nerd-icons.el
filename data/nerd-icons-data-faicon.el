...
(defvar nerd-icons/faicon-alist
  '(
    ...
    ("nf-fa-lemon_o" . "\xf094")
    ("nf-fa-less" . "\xed48")
    ("nf-fa-less_than" . "\xee00")
    ("nf-fa-less_than_equal" . "\xee01")
    ...
    ("nf-fa-microphone_lines_slash" . "\xee03")
    ...
    ("nf-fa-mizuni" . "\xed06")
    ("nf-fa-mobile" . "\xed08")
    ("nf-fa-mobile_button" . "\xf10b")
    ("nf-fa-mobile_phone" . "\xf10b")
    ("nf-fa-mobile_screen" . "\xed09")
    ("nf-fa-mobile_screen_button" . "\xed07")
    ("nf-fa-modx" . "\xf285")
    ("nf-fa-monero" . "\xed0a")
    ("nf-fa-money" . "\xf0d6")
    ("nf-fa-money_bill" . "\xf0d6")
    ("nf-fa-money_bill_1" . "\xed0b")
    ("nf-fa-money_bill_1_wave" . "\xee05")
    ("nf-fa-money_bill_wave" . "\xee04")
    ("nf-fa-money_check" . "\xee06")
    ("nf-fa-money_check_dollar" . "\xee07")
    ...
    ("nf-fa-tablet" . "\xed2e")
    ("nf-fa-tablet_button" . "\xf10a")
    ("nf-fa-tablet_screen_button" . "\xed2d")
    ("nf-fa-tablets" . "\xed8e")
